...
public class ToorlaParser extends Parser {
    ...
    public static final int RULE_program = 0,
            ...
            RULE_entryClassDeclaration = 2,
            RULE_fieldDeclaration = 3,
            RULE_access_modifier = 4,
            RULE_methodDeclaration = 5,
            RULE_closedStatement = 6,
            RULE_closedConditional = 7,
            RULE_openConditional = 8,
            RULE_openStatement = 9,
            RULE_statement = 10,
            RULE_statementVarDef = 11,
            RULE_statementBlock = 12,
            RULE_statementContinue = 13,
            RULE_statementBreak = 14,
            RULE_statementReturn = 15,
            RULE_statementClosedLoop = 16,
            RULE_statementOpenLoop = 17,
            RULE_statementWrite = 18,
            RULE_statementAssignment = 19,
            RULE_statementInc = 20,
            RULE_statementDec = 21,
            RULE_expression = 22,
            RULE_expressionOr = 23,
            RULE_expressionOrTemp = 24,
            RULE_expressionAnd = 25,
            RULE_expressionAndTemp = 26,
            RULE_expressionEq = 27,
            RULE_expressionEqTemp = 28,
            RULE_expressionCmp = 29,
            RULE_expressionCmpTemp = 30,
            RULE_expressionAdd = 31,
            RULE_expressionAddTemp = 32,
            RULE_expressionMultMod = 33,
            RULE_expressionMultModTemp = 34,
            RULE_expressionUnary = 35,
            RULE_expressionMethods = 36,
            RULE_expressionMethodsTemp = 37,
            RULE_expressionOther = 38,
            RULE_toorlaType = 39,
            RULE_singleType = 40;
    ...
    public final ClassDeclarationContext classDeclaration(boolean isEntry)
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                Identifier className =
                        new Identifier(
                                (((ClassDeclarationContext) _localctx).n != null
                                        ? ((ClassDeclarationContext) _localctx).n.getText()
                                        : null));
                Identifier parentName = new Identifier(null);
                setNodePosition(
                        className,
                        ((ClassDeclarationContext) _localctx).n.getLine(),
                        ((ClassDeclarationContext) _localctx).n.getCharPositionInLine());
                if (((ClassDeclarationContext) _localctx).p != null
                        && (((ClassDeclarationContext) _localctx).p != null
                                        ? ((ClassDeclarationContext) _localctx).p.getText()
                                        : null)
                                != null) {
                    parentName =
                            new Identifier(
                    ...
                    setNodePosition(
                            parentName,
                            ((ClassDeclarationContext) _localctx).p.getLine(),
                            ((ClassDeclarationContext) _localctx).p.getCharPositionInLine());
                }
                if (isEntry)
                    ((ClassDeclarationContext) _localctx).mClass =
                            new EntryClassDeclaration(className, parentName);
                else
                    ((ClassDeclarationContext) _localctx).mClass =
                            new ClassDeclaration(className, parentName);
                            ...
                            case 1:
                                {
                                    ...
                                    _localctx.mClass.addFieldsDeclarations(
                                            ((ClassDeclarationContext) _localctx).f.mFields);
                                }
                                break;
                            case 2:
                                {
                                    ...
                                    _localctx.mClass.addMethodDeclaration(
                                            ((ClassDeclarationContext) _localctx).m.mMethod);
                                }
                                break;
                        }
                    }
    ...
    public final EntryClassDeclarationContext entryClassDeclaration() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                ((EntryClassDeclarationContext) _localctx).mClass =
                        ((EntryClassDeclarationContext) _localctx).c.mClass;
            }
        } catch (RecognitionException re) {
            _localctx.exception = re;
            _errHandler.reportError(this, re);
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                if (_la == T__8 || _la == T__9) {
                    {
                        ...
                        ((FieldDeclarationContext) _localctx).access =
                                ((FieldDeclarationContext) _localctx).a.mAccess;
                    }
                }
                ...
                Identifier fieldName =
                        new Identifier(
                                (((FieldDeclarationContext) _localctx).i != null
                                        ? ((FieldDeclarationContext) _localctx).i.getText()
                                        : null));
                setNodePosition(
                        fieldName,
                        ((FieldDeclarationContext) _localctx).i.getLine(),
                        ((FieldDeclarationContext) _localctx).i.getCharPositionInLine());
                    ...
                    {
                        {
                            ...
                            fieldName =
                                    new Identifier(
                                            (((FieldDeclarationContext) _localctx).ii != null
                                                    ? ((FieldDeclarationContext) _localctx)
                                                            .ii.getText()
                                                    : null));
                            setNodePosition(
                                    fieldName,
                                    ((FieldDeclarationContext) _localctx).ii.getLine(),
                                    ((FieldDeclarationContext) _localctx)
                                            .ii.getCharPositionInLine());
            ...
            switch (_input.LA(1)) {
                case T__8:
                    enterOuterAlt(_localctx, 1);
                    {
                        ...
                        ((Access_modifierContext) _localctx).mAccess =
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                if (_la == T__8 || _la == T__9) {
                    {
                        ...
                        ((MethodDeclarationContext) _localctx).access =
                                ((MethodDeclarationContext) _localctx).a.mAccess;
                    }
                }
                ...
                Identifier methodName =
                        new Identifier(
                                (((MethodDeclarationContext) _localctx).i != null
                                        ? ((MethodDeclarationContext) _localctx).i.getText()
                                        : null));
                setNodePosition(
                        methodName,
                        ((MethodDeclarationContext) _localctx).i.getLine(),
                        ((MethodDeclarationContext) _localctx).i.getCharPositionInLine());
                        ...
                        {
                            {
                                ...
                                Identifier parameterName =
                                        new Identifier(
                                                (((MethodDeclarationContext) _localctx).i1 != null
                                                        ? ((MethodDeclarationContext) _localctx)
                                                                .i1.getText()
                                                        : null));
                                setNodePosition(
                                        parameterName,
                                        ((MethodDeclarationContext) _localctx).i1.getLine(),
                                        ((MethodDeclarationContext) _localctx)
                                                .i1.getCharPositionInLine());
                                ParameterDeclaration parameterDecl =
                                        new ParameterDeclaration(
                                                parameterName,
                                                ((MethodDeclarationContext) _localctx).t1.mType);
                                setNodePosition(
                                        parameterDecl,
                                        ((MethodDeclarationContext) _localctx).i1.getLine(),
                                        ((MethodDeclarationContext) _localctx)
                                    ...
                                    {
                                        {
                                            ...
                                            match(T__2);
                                            setState(173);
                                            ((MethodDeclarationContext) _localctx).t2 =
                                                    toorlaType();
                    ...
                    {
                        {
                            ...
                            _localctx.mMethod.addStatement(
                                    ((MethodDeclarationContext) _localctx).s.mStmt);
                        }
                    }
                    setState(196);
                    _errHandler.sync(this);
            ...
            switch (getInterpreter().adaptivePredict(_input, 12, _ctx)) {
                case 1:
                    enterOuterAlt(_localctx, 1);
                    {
                        ...
                        ((ClosedStatementContext) _localctx).mStmt =
                                ((ClosedStatementContext) _localctx).s1.mStmt;
                    }
                    break;
                case 2:
                    enterOuterAlt(_localctx, 2);
                    {
                        ...
                        ((ClosedStatementContext) _localctx).mStmt =
                                ((ClosedStatementContext) _localctx).conditionalStat.mStmt;
                    }
                    break;
                case 3:
                    enterOuterAlt(_localctx, 3);
                    {
                        ...
                        ((ClosedStatementContext) _localctx).mStmt =
                                ((ClosedStatementContext) _localctx).s3.mStmt;
                    }
                    break;
                case 4:
                    enterOuterAlt(_localctx, 4);
                    {
                        ...
                        ((ClosedStatementContext) _localctx).mStmt =
                                ((ClosedStatementContext) _localctx).s4.mStmt;
                    }
                    break;
                case 5:
                    enterOuterAlt(_localctx, 5);
                    {
                        ...
                        ((ClosedStatementContext) _localctx).mStmt =
                                ((ClosedStatementContext) _localctx).s5.mStmt;
                    }
                    break;
                case 6:
                    enterOuterAlt(_localctx, 6);
                    {
                        ...
                        ((ClosedStatementContext) _localctx).mStmt =
                                ((ClosedStatementContext) _localctx).s6.mStmt;
                    }
                    break;
                case 7:
                    enterOuterAlt(_localctx, 7);
                    {
                        ...
                        ((ClosedStatementContext) _localctx).mStmt =
                                ((ClosedStatementContext) _localctx).s7.mStmt;
                    }
                    break;
                case 8:
                    enterOuterAlt(_localctx, 8);
                    {
                        ...
                        ((ClosedStatementContext) _localctx).mStmt =
                                ((ClosedStatementContext) _localctx).s8.mStmt;
                    }
                    break;
                case 9:
                    enterOuterAlt(_localctx, 9);
                    {
                        ...
                        ((ClosedStatementContext) _localctx).mStmt =
                                ((ClosedStatementContext) _localctx).s9.mStmt;
                    }
                    break;
                case 10:
                    enterOuterAlt(_localctx, 10);
                    {
                        ...
                        ((ClosedStatementContext) _localctx).mStmt =
                                ((ClosedStatementContext) _localctx).incStat.incStatement;
                    }
                    break;
                case 11:
                    enterOuterAlt(_localctx, 11);
                    {
                        ...
                        ((ClosedStatementContext) _localctx).mStmt =
                                ((ClosedStatementContext) _localctx).decStat.decStatement;
                    }
                    break;
                case 12:
    ...
    public final ClosedConditionalContext closedConditional() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                    ...
                    {
                        {
                            ...
                            _localctx.conditions.add(
                                    ((ClosedConditionalContext) _localctx).elifExp.expr);
                            _localctx.statements.add(
                                    ((ClosedConditionalContext) _localctx).elifStat.mStmt);
                        }
                    }
                    setState(255);
                    _errHandler.sync(this);
                ...
                Expression lastIfCondition =
                        _localctx.conditions.get(_localctx.conditions.size() - 1);
                Conditional previousConditionalStat =
                        new Conditional(
                                lastIfCondition,
                                lastIfStat,
                                ((ClosedConditionalContext) _localctx).elseStmt.mStmt);
                ...
                for (int i = _localctx.statements.size() - 2; i >= 0; i--) {
                    ...
                    currentConditionalStat =
                            new Conditional(
                                    currentIfCondition, currentIfStat, previousConditionalStat);
                }
                    ...
                    {
                        {
                            ...
                            ((OpenConditionalContext) _localctx).mStmt =
                                    new Conditional(
                                            ((OpenConditionalContext) _localctx).ifExp.expr,
                                            ((OpenConditionalContext) _localctx).ifStat.mStmt);
                        }
                    }
                    break;
                case 2:
                    ...
                    {
                        {
                            ...
                            _localctx.conditions.add(
                                    ((OpenConditionalContext) _localctx).ifExp.expr);
                            _localctx.statements.add(
                                    ((OpenConditionalContext) _localctx).secondIfStat.mStmt);
                                    ...
                                    {
                                        {
                                            ...
                                            match(T__11);
                                            setState(275);
                                            ((OpenConditionalContext) _localctx).elifExp =
                                                    expression();
                                            setState(276);
                                            match(T__12);
                                            setState(277);
                                            ((OpenConditionalContext) _localctx).elifStat =
                                                    closedStatement();

                                            _localctx.conditions.add(
                                                    ((OpenConditionalContext) _localctx)
                                                            .elifExp
                                                            .expr);
                                            _localctx.statements.add(
                                                    ((OpenConditionalContext) _localctx)
                            ...
                            Conditional previousConditionalStat =
                                    new Conditional(
                                            ((OpenConditionalContext) _localctx).lastElifExp.expr,
                                            ((OpenConditionalContext) _localctx).lastElifStmt.mStmt,
                                            new Skip());
                            Conditional currentConditionalStat = previousConditionalStat;
                    ...
                    {
                        {
                            ...
                            _localctx.conditions.add(
                                    ((OpenConditionalContext) _localctx).ifExp.expr);
                            _localctx.statements.add(
                                    ((OpenConditionalContext) _localctx).thirdIfStat.mStmt);
                                ...
                                {
                                    {
                                        ...
                                        _localctx.conditions.add(
                                                ((OpenConditionalContext) _localctx).elifExp.expr);
                                        _localctx.statements.add(
                                                ((OpenConditionalContext) _localctx)
                                                        .elifStat
                                                        .mStmt);
                            ...
                            Statement lastIfStat =
                                    _localctx.statements.get(_localctx.statements.size() - 1);
                            Expression lastIfCondition =
                                    _localctx.conditions.get(_localctx.conditions.size() - 1);
                            Conditional previousConditionalStat =
                                    new Conditional(
                                            lastIfCondition,
                                            lastIfStat,
                                            ((OpenConditionalContext) _localctx).elseStmt.mStmt);
                            Conditional currentConditionalStat = previousConditionalStat;
                            for (int i = _localctx.statements.size() - 2; i >= 0; i--) {
                                previousConditionalStat = currentConditionalStat;
                                Expression currentIfCondition = _localctx.conditions.get(i);
            ...
            switch (_input.LA(1)) {
                case T__23:
                    enterOuterAlt(_localctx, 1);
                    {
                        ...
                        ((OpenStatementContext) _localctx).mStmt =
                                ((OpenStatementContext) _localctx).s1.mStmt;
                    }
                    break;
                case T__14:
                    enterOuterAlt(_localctx, 2);
                    {
                        ...
                        ((OpenStatementContext) _localctx).mStmt =
                                ((OpenStatementContext) _localctx).conditionalStat.mStmt;
                    }
                    break;
                default:
                    throw new NoViableAltException(this);
            ...
            switch (getInterpreter().adaptivePredict(_input, 18, _ctx)) {
                case 1:
                    enterOuterAlt(_localctx, 1);
                    {
                        ...
                        ((StatementContext) _localctx).mStmt =
                                ((StatementContext) _localctx).s1.mStmt;
                    }
                    break;
                case 2:
                    enterOuterAlt(_localctx, 2);
                    {
                        ...
                        ((StatementContext) _localctx).mStmt =
                                ((StatementContext) _localctx).s2.mStmt;
                    }
                    break;
            }
        } catch (RecognitionException re) {
    ...
    public final StatementVarDefContext statementVarDef() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                Identifier localVarName =
                        new Identifier(
                                (((StatementVarDefContext) _localctx).i1 != null
                                        ? ((StatementVarDefContext) _localctx).i1.getText()
                                        : null));
                setNodePosition(
                        localVarName,
                        ((StatementVarDefContext) _localctx).i1.getLine(),
                        ((StatementVarDefContext) _localctx).i1.getCharPositionInLine());
                LocalVarDef localVarDef =
                        new LocalVarDef(localVarName, ((StatementVarDefContext) _localctx).e1.expr);
                setNodePosition(
                        localVarDef,
                        ((StatementVarDefContext) _localctx).i1.getLine(),
                        ((StatementVarDefContext) _localctx).i1.getCharPositionInLine());
                    ...
                    {
                        {
                            ...
                            localVarName =
                                    new Identifier(
                                            (((StatementVarDefContext) _localctx).i2 != null
                                                    ? ((StatementVarDefContext) _localctx)
                                                            .i2.getText()
                                                    : null));
                            setNodePosition(
                                    localVarName,
                                    ((StatementVarDefContext) _localctx).i2.getLine(),
                                    ((StatementVarDefContext) _localctx)
                                            .i2.getCharPositionInLine());
                            localVarDef =
                                    new LocalVarDef(
                                            localVarName,
                                            ((StatementVarDefContext) _localctx).e2.expr);
                            setNodePosition(
                                    localVarDef,
                                    ((StatementVarDefContext) _localctx).i2.getLine(),
                                    ((StatementVarDefContext) _localctx)
                    ...
                    {
                        {
                            ...
                            ((Block) _localctx.mStmt)
                                    .addStatement(((StatementBlockContext) _localctx).s.mStmt);
                        }
                    }
                    setState(360);
                    _errHandler.sync(this);
    ...
    public final StatementContinueContext statementContinue() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                setNodePosition(
                        _localctx.mStmt,
                        ((StatementContinueContext) _localctx).myContinue.getLine(),
                        ((StatementContinueContext) _localctx).myContinue.getCharPositionInLine());
            }
        } catch (RecognitionException re) {
            _localctx.exception = re;
            _errHandler.reportError(this, re);
    ...
    public final StatementBreakContext statementBreak() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                setNodePosition(
                        _localctx.mStmt,
                        ((StatementBreakContext) _localctx).myBreak.getLine(),
                        ((StatementBreakContext) _localctx).myBreak.getCharPositionInLine());
            }
        } catch (RecognitionException re) {
            _localctx.exception = re;
            _errHandler.reportError(this, re);
    ...
    public final StatementReturnContext statementReturn() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                ((StatementReturnContext) _localctx).mStmt =
                        new Return(((StatementReturnContext) _localctx).e.expr);
                setNodePosition(
                        _localctx.mStmt,
                        ((StatementReturnContext) _localctx).myReturn.getLine(),
                        ((StatementReturnContext) _localctx).myReturn.getCharPositionInLine());
            }
        } catch (RecognitionException re) {
            _localctx.exception = re;
            _errHandler.reportError(this, re);
    ...
    public final StatementClosedLoopContext statementClosedLoop() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                ((StatementClosedLoopContext) _localctx).mStmt =
                        new While(
                                ((StatementClosedLoopContext) _localctx).e.expr,
                                ((StatementClosedLoopContext) _localctx).s.mStmt);
            }
        } catch (RecognitionException re) {
            _localctx.exception = re;
            _errHandler.reportError(this, re);
    ...
    public final StatementOpenLoopContext statementOpenLoop() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                ((StatementOpenLoopContext) _localctx).mStmt =
                        new While(
                                ((StatementOpenLoopContext) _localctx).e.expr,
                                ((StatementOpenLoopContext) _localctx).s.mStmt);
            }
        } catch (RecognitionException re) {
            _localctx.exception = re;
            _errHandler.reportError(this, re);
    ...
    public final StatementWriteContext statementWrite() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                ((StatementWriteContext) _localctx).mStmt =
                        new PrintLine(((StatementWriteContext) _localctx).e.expr);
                setNodePosition(
                        _localctx.mStmt,
                        ((StatementWriteContext) _localctx).printLine.getLine(),
                        ((StatementWriteContext) _localctx).printLine.getCharPositionInLine());
            }
        } catch (RecognitionException re) {
            _localctx.exception = re;
            _errHandler.reportError(this, re);
    ...
    public final StatementAssignmentContext statementAssignment() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                ((StatementAssignmentContext) _localctx).mStmt =
                        new Assign(
                                ((StatementAssignmentContext) _localctx).left.expr,
                                ((StatementAssignmentContext) _localctx).right.expr);
                setNodePosition(
                        _localctx.mStmt,
                        ((StatementAssignmentContext) _localctx).assignOp.getLine(),
                        ((StatementAssignmentContext) _localctx).assignOp.getCharPositionInLine());
            }
        } catch (RecognitionException re) {
            _localctx.exception = re;
            _errHandler.reportError(this, re);
    ...
    public final StatementIncContext statementInc() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                ((StatementIncContext) _localctx).incStatement =
                        new IncStatement(((StatementIncContext) _localctx).lvalExpr.expr);
                setNodePosition(
                        _localctx.incStatement,
                        ((StatementIncContext) _localctx).incOp.getLine(),
                        ((StatementIncContext) _localctx).incOp.getCharPositionInLine());
            }
        } catch (RecognitionException re) {
            _localctx.exception = re;
            _errHandler.reportError(this, re);
    ...
    public final StatementDecContext statementDec() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                ((StatementDecContext) _localctx).decStatement =
                        new DecStatement(((StatementDecContext) _localctx).lvalExpr.expr);
                setNodePosition(
                        _localctx.decStatement,
                        ((StatementDecContext) _localctx).decOp.getLine(),
                        ((StatementDecContext) _localctx).decOp.getCharPositionInLine());
            }
        } catch (RecognitionException re) {
            _localctx.exception = re;
            _errHandler.reportError(this, re);
    ...
    public final ExpressionOrContext expressionOr() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                setState(417);
                ((ExpressionOrContext) _localctx).ot =
                        expressionOrTemp(((ExpressionOrContext) _localctx).a.expr);
    ...
    public final ExpressionOrTempContext expressionOrTemp(Expression leftOperand)
            throws RecognitionException {
        ExpressionOrTempContext _localctx =
                new ExpressionOrTempContext(_ctx, getState(), leftOperand);
            ...
            switch (_input.LA(1)) {
                case T__27:
                    enterOuterAlt(_localctx, 1);
                    {
                        ...
                        ((ExpressionOrTempContext) _localctx).middleExpr =
                                new Or(
                                        _localctx.leftOperand,
                                        ((ExpressionOrTempContext) _localctx).a.expr);
                        setNodePosition(
                                _localctx.middleExpr,
                                ((ExpressionOrTempContext) _localctx).orOp.getLine(),
                                ((ExpressionOrTempContext) _localctx).orOp.getCharPositionInLine());

                        setState(423);
                        ((ExpressionOrTempContext) _localctx).ot =
                                expressionOrTemp(_localctx.middleExpr);

                        ((ExpressionOrTempContext) _localctx).expr =
                                ((ExpressionOrTempContext) _localctx).ot.expr;
                    }
                    break;
                case T__6:
                case T__7:
    ...
    public final ExpressionAndContext expressionAnd() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                setState(430);
                ((ExpressionAndContext) _localctx).at =
                        expressionAndTemp(((ExpressionAndContext) _localctx).e.expr);

                ((ExpressionAndContext) _localctx).expr =
                        ((ExpressionAndContext) _localctx).at.expr;
            }
        } catch (RecognitionException re) {
            _localctx.exception = re;
            _errHandler.reportError(this, re);
    ...
    public final ExpressionAndTempContext expressionAndTemp(Expression leftOperand)
            throws RecognitionException {
        ExpressionAndTempContext _localctx =
                new ExpressionAndTempContext(_ctx, getState(), leftOperand);
            ...
            switch (_input.LA(1)) {
                case T__28:
                    enterOuterAlt(_localctx, 1);
                    {
                        ...
                        ((ExpressionAndTempContext) _localctx).middleExpr =
                                new And(
                                        _localctx.leftOperand,
                                        ((ExpressionAndTempContext) _localctx).e.expr);
                        setNodePosition(
                                _localctx.middleExpr,
                                ((ExpressionAndTempContext) _localctx).andOp.getLine(),
                                ((ExpressionAndTempContext) _localctx)
                                        .andOp.getCharPositionInLine());

                        setState(436);
                        ((ExpressionAndTempContext) _localctx).at =
                                expressionAndTemp(_localctx.middleExpr);

                        ((ExpressionAndTempContext) _localctx).expr =
                                ((ExpressionAndTempContext) _localctx).at.expr;
                    }
                    break;
                case T__6:
                case T__7:
    ...
    public final ExpressionEqContext expressionEq() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                setState(443);
                ((ExpressionEqContext) _localctx).et =
                        expressionEqTemp(((ExpressionEqContext) _localctx).c.expr);
    ...
    public final ExpressionEqTempContext expressionEqTemp(Expression leftOperand)
            throws RecognitionException {
        ExpressionEqTempContext _localctx =
                new ExpressionEqTempContext(_ctx, getState(), leftOperand);
            ...
            switch (_input.LA(1)) {
                ...
                case T__30:
                    enterOuterAlt(_localctx, 1);
                    {
                            ...
                            case T__29:
                                {
                                    ...
                                    setNodePosition(
                                            _localctx.middleExpr,
                                            ((ExpressionEqTempContext) _localctx).eqOp.getLine(),
                                            ((ExpressionEqTempContext) _localctx)
                                                    .eqOp.getCharPositionInLine());
                                }
                                break;
                            case T__30:
                                {
                                    ...
                                    ((ExpressionEqTempContext) _localctx).middleExpr =
                                            new NotEquals();
                                    setNodePosition(
                                            _localctx.middleExpr,
                                            ((ExpressionEqTempContext) _localctx).neqOp.getLine(),
                                            ((ExpressionEqTempContext) _localctx)
                                                    .neqOp.getCharPositionInLine());
                                }
                                break;
                            default:
                                throw new NoViableAltException(this);
                        ...
                        _localctx.middleExpr.setSides(
                                _localctx.leftOperand,
                                ((ExpressionEqTempContext) _localctx).c.expr);

                        setState(454);
                        ((ExpressionEqTempContext) _localctx).et =
                                expressionEqTemp(_localctx.middleExpr);

                        ((ExpressionEqTempContext) _localctx).expr =
                                ((ExpressionEqTempContext) _localctx).et.expr;
                    }
                    break;
                case T__6:
                case T__7:
    ...
    public final ExpressionCmpContext expressionCmp() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                setState(461);
                ((ExpressionCmpContext) _localctx).ct =
                        expressionCmpTemp(((ExpressionCmpContext) _localctx).a.expr);

                ((ExpressionCmpContext) _localctx).expr =
                        ((ExpressionCmpContext) _localctx).ct.expr;
            }
        } catch (RecognitionException re) {
            _localctx.exception = re;
            _errHandler.reportError(this, re);
    ...
    public final ExpressionCmpTempContext expressionCmpTemp(Expression leftOperand)
            throws RecognitionException {
        ExpressionCmpTempContext _localctx =
                new ExpressionCmpTempContext(_ctx, getState(), leftOperand);
            ...
            switch (_input.LA(1)) {
                ...
                case T__32:
                    enterOuterAlt(_localctx, 1);
                    {
                            ...
                            case T__31:
                                {
                                    ...
                                    ((ExpressionCmpTempContext) _localctx).middleExpr =
                                            new LessThan();
                                    setNodePosition(
                                            _localctx.middleExpr,
                                            ((ExpressionCmpTempContext) _localctx).ltOp.getLine(),
                                            ((ExpressionCmpTempContext) _localctx)
                                                    .ltOp.getCharPositionInLine());
                                }
                                break;
                            case T__32:
                                {
                                    ...
                                    setNodePosition(
                                            _localctx.middleExpr,
                                            ((ExpressionCmpTempContext) _localctx).gtOp.getLine(),
                                            ((ExpressionCmpTempContext) _localctx)
                                                    .gtOp.getCharPositionInLine());
                                }
                                break;
                            default:
                                throw new NoViableAltException(this);
                        ...
                        _localctx.middleExpr.setSides(
                                _localctx.leftOperand,
                                ((ExpressionCmpTempContext) _localctx).a.expr);

                        setState(472);
                        ((ExpressionCmpTempContext) _localctx).ct =
                                expressionCmpTemp(_localctx.middleExpr);

                        ((ExpressionCmpTempContext) _localctx).expr =
                                ((ExpressionCmpTempContext) _localctx).ct.expr;
                    }
                    break;
                case T__6:
                case T__7:
    ...
    public final ExpressionAddContext expressionAdd() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                setState(479);
                ((ExpressionAddContext) _localctx).at =
                        expressionAddTemp(((ExpressionAddContext) _localctx).m.expr);

                ((ExpressionAddContext) _localctx).expr =
                        ((ExpressionAddContext) _localctx).at.expr;
            }
        } catch (RecognitionException re) {
            _localctx.exception = re;
            _errHandler.reportError(this, re);
    ...
    public final ExpressionAddTempContext expressionAddTemp(Expression leftOperand)
            throws RecognitionException {
        ExpressionAddTempContext _localctx =
                new ExpressionAddTempContext(_ctx, getState(), leftOperand);
            ...
            switch (_input.LA(1)) {
                ...
                case T__34:
                    enterOuterAlt(_localctx, 1);
                    {
                            ...
                            case T__33:
                                {
                                    ...
                                    setNodePosition(
                                            _localctx.middleExpr,
                                            ((ExpressionAddTempContext) _localctx).addOp.getLine(),
                                            ((ExpressionAddTempContext) _localctx)
                                                    .addOp.getCharPositionInLine());
                                }
                                break;
                            case T__34:
                                {
                                    ...
                                    setNodePosition(
                                            _localctx.middleExpr,
                                            ((ExpressionAddTempContext) _localctx).subOp.getLine(),
                                            ((ExpressionAddTempContext) _localctx)
                                                    .subOp.getCharPositionInLine());
                                }
                                break;
                            default:
                                throw new NoViableAltException(this);
                        ...
                        _localctx.middleExpr.setSides(
                                _localctx.leftOperand,
                                ((ExpressionAddTempContext) _localctx).m.expr);

                        setState(490);
                        ((ExpressionAddTempContext) _localctx).at =
                                expressionAddTemp(_localctx.middleExpr);

                        ((ExpressionAddTempContext) _localctx).expr =
                                ((ExpressionAddTempContext) _localctx).at.expr;
                    }
                    break;
                case T__6:
                case T__7:
    ...
    public final ExpressionMultModContext expressionMultMod() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                setState(497);
                ((ExpressionMultModContext) _localctx).mt =
                        expressionMultModTemp(((ExpressionMultModContext) _localctx).u.expr);

                ((ExpressionMultModContext) _localctx).expr =
                        ((ExpressionMultModContext) _localctx).mt.expr;
            }
        } catch (RecognitionException re) {
            _localctx.exception = re;
            _errHandler.reportError(this, re);
    ...
    public final ExpressionMultModTempContext expressionMultModTemp(Expression leftOperand)
            throws RecognitionException {
        ExpressionMultModTempContext _localctx =
                new ExpressionMultModTempContext(_ctx, getState(), leftOperand);
            ...
            switch (_input.LA(1)) {
                ...
                case T__37:
                    enterOuterAlt(_localctx, 1);
                    {
                            ...
                            case T__35:
                                {
                                    ...
                                    ((ExpressionMultModTempContext) _localctx).middleExpr =
                                            new Times();
                                    setNodePosition(
                                            _localctx.middleExpr,
                                            ((ExpressionMultModTempContext) _localctx)
                        ...
                        _localctx.middleExpr.setSides(
                                _localctx.leftOperand,
                                ((ExpressionMultModTempContext) _localctx).u.expr);

                        setState(510);
                        ((ExpressionMultModTempContext) _localctx).mt =
                                expressionMultModTemp(_localctx.middleExpr);

                        ((ExpressionMultModTempContext) _localctx).expr =
                                ((ExpressionMultModTempContext) _localctx).mt.expr;
                    }
                    break;
                case T__6:
                case T__7:
            ...
            switch (_input.LA(1)) {
                ...
                case T__38:
                    enterOuterAlt(_localctx, 1);
                    {
                            ...
                            case T__38:
                                {
                                    ...
                                    setNodePosition(
                                            _localctx.expr,
                                            ((ExpressionUnaryContext) _localctx).notOp.getLine(),
                                            ((ExpressionUnaryContext) _localctx)
                                                    .notOp.getCharPositionInLine());
                                }
                                break;
                            case T__34:
                                {
                                    ...
                                    setNodePosition(
                                            _localctx.expr,
                                            ((ExpressionUnaryContext) _localctx).negOp.getLine(),
                                            ((ExpressionUnaryContext) _localctx)
                                                    .negOp.getCharPositionInLine());
                                }
                                break;
                            default:
                                throw new NoViableAltException(this);
                        ...
                        ((UnaryExpression) _localctx.expr)
                                .setExpr(((ExpressionUnaryContext) _localctx).u.expr);
                    }
                    break;
                case T__11:
                case T__42:
                ...
                case ID:
                    enterOuterAlt(_localctx, 2);
                    {
                        ...
                        ((ExpressionUnaryContext) _localctx).expr =
                                ((ExpressionUnaryContext) _localctx).m.expr;
                    }
                    break;
                default:
                    throw new NoViableAltException(this);
    ...
    public final ExpressionMethodsContext expressionMethods() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                setState(531);
                ((ExpressionMethodsContext) _localctx).mt =
                        expressionMethodsTemp(((ExpressionMethodsContext) _localctx).o.expr);

                ((ExpressionMethodsContext) _localctx).expr =
                        ((ExpressionMethodsContext) _localctx).mt.expr;
            }
        } catch (RecognitionException re) {
            _localctx.exception = re;
            _errHandler.reportError(this, re);
    ...
    public final ExpressionMethodsTempContext expressionMethodsTemp(Expression instance)
            throws RecognitionException {
        ExpressionMethodsTempContext _localctx =
                new ExpressionMethodsTempContext(_ctx, getState(), instance);
                    ...
                    enterOuterAlt(_localctx, 1);
                    {
                        ...
                        switch (getInterpreter().adaptivePredict(_input, 35, _ctx)) {
                            case 1:
                                {
                                    ...
                                    Identifier methodName =
                                            new Identifier(
                                                    (((ExpressionMethodsTempContext) _localctx).i
                                                                    != null
                                    ...
                                    setNodePosition(
                                            methodName,
                                            ((ExpressionMethodsTempContext) _localctx).i.getLine(),
                                            ((ExpressionMethodsTempContext) _localctx)
                                                    .i.getCharPositionInLine());
                                    ((ExpressionMethodsTempContext) _localctx).immediateExpr =
                                            new MethodCall(_localctx.instance, methodName);
                                    setNodePosition(
                                            _localctx.immediateExpr,
                                            ((ExpressionMethodsTempContext) _localctx)
                                                    .dotOp.getLine(),
                                            ((ExpressionMethodsTempContext) _localctx)
                                                    .dotOp.getCharPositionInLine());
                                    ...
                                    _la = _input.LA(1);
                                    if ((((_la) & ~0x3f) == 0
                                            && ((1L << _la) & 12517424486158336L) != 0)) {
                                        {
                                            setState(538);
                                            ((ExpressionMethodsTempContext) _localctx).e1 =
                                                    expression();
                                            ((MethodCall) _localctx.immediateExpr)
                                                    .addArg(
                                                            ((ExpressionMethodsTempContext)
                                                                            _localctx)
                                                                    .e1
                            ...
                            case 2:
                                {
                                    ...
                                    Identifier fieldName =
                                            new Identifier(
                                                    (((ExpressionMethodsTempContext) _localctx).ii
                                                                    != null
                                                            ? ((ExpressionMethodsTempContext)
                                                                            _localctx)
                                                                    .ii.getText()
                                    ...
                                    setNodePosition(
                                            fieldName,
                                            ((ExpressionMethodsTempContext) _localctx).ii.getLine(),
                                            ((ExpressionMethodsTempContext) _localctx)
                                                    .ii.getCharPositionInLine());
                                    ((ExpressionMethodsTempContext) _localctx).immediateExpr =
                                            new FieldCall(_localctx.instance, fieldName);
                                    setNodePosition(
                                            _localctx.immediateExpr,
                                            ((ExpressionMethodsTempContext) _localctx)
                                                    .dotOp.getLine(),
                            ...
                            case 3:
                                {
                                    setState(555);
                                    ((ExpressionMethodsTempContext) _localctx).leftBrace =
                                            match(T__40);
                                    setState(556);
                                    ...
                                    setNodePosition(
                                            ...
                                            ((ExpressionMethodsTempContext) _localctx)
                                                    .leftBrace.getLine(),
                                            ((ExpressionMethodsTempContext) _localctx)
                                                    .leftBrace.getCharPositionInLine());
                                }
                                break;
                        }
                        setState(562);
                        ((ExpressionMethodsTempContext) _localctx).mt =
                                expressionMethodsTemp(_localctx.immediateExpr);

                        ((ExpressionMethodsTempContext) _localctx).expr =
                                ((ExpressionMethodsTempContext) _localctx).mt.expr;
                    }
                    break;
                case T__6:
                case T__7:
            ...
            switch (getInterpreter().adaptivePredict(_input, 39, _ctx)) {
                case 1:
                    enterOuterAlt(_localctx, 1);
                    {
                        ...
                        ((ExpressionOtherContext) _localctx).expr =
                                new IntValue(
                                        (((ExpressionOtherContext) _localctx).n != null
                                                ? Integer.valueOf(
                                                        ((ExpressionOtherContext) _localctx)
                                                                .n.getText())
                                                : 0));
                        setNodePosition(
                                _localctx.expr,
                                ((ExpressionOtherContext) _localctx).n.getLine(),
                                ((ExpressionOtherContext) _localctx).n.getCharPositionInLine());
                    }
                    break;
                case 2:
                    enterOuterAlt(_localctx, 2);
                    {
                        ...
                        ((ExpressionOtherContext) _localctx).expr =
                                new StringValue(
                                        (((ExpressionOtherContext) _localctx).s != null
                                                ? ((ExpressionOtherContext) _localctx).s.getText()
                                                : null));
                        setNodePosition(
                                _localctx.expr,
                                ((ExpressionOtherContext) _localctx).s.getLine(),
                                ((ExpressionOtherContext) _localctx).s.getCharPositionInLine());
                    }
                    break;
                case 3:
                    enterOuterAlt(_localctx, 3);
                    {
                        ...
                        ((ExpressionOtherContext) _localctx).expr =
                                new NewArray(
                                        ((ExpressionOtherContext) _localctx).st.sType,
                                        ((ExpressionOtherContext) _localctx).size.expr);
                        setNodePosition(
                                _localctx.expr,
                                ((ExpressionOtherContext) _localctx).newModifier.getLine(),
                                ((ExpressionOtherContext) _localctx)
                                        .newModifier.getCharPositionInLine());
                    }
                    break;
                case 4:
                    enterOuterAlt(_localctx, 4);
                    {
                        ...
                        Identifier instanceClass =
                                new Identifier(
                                        (((ExpressionOtherContext) _localctx).i != null
                                                ? ((ExpressionOtherContext) _localctx).i.getText()
                                                : null));
                        setNodePosition(
                                instanceClass,
                                ((ExpressionOtherContext) _localctx).i.getLine(),
                                ((ExpressionOtherContext) _localctx).i.getCharPositionInLine());
                        ((ExpressionOtherContext) _localctx).expr =
                                new NewClassInstance(instanceClass);
                        setNodePosition(
                                _localctx.expr,
                                ((ExpressionOtherContext) _localctx).newModifier.getLine(),
                                ((ExpressionOtherContext) _localctx)
                ...
                case 5:
                    enterOuterAlt(_localctx, 5);
                    {
                        ...
                        setNodePosition(
                                _localctx.expr,
                                ((ExpressionOtherContext) _localctx).selfModifier.getLine(),
                                ((ExpressionOtherContext) _localctx)
                                        .selfModifier.getCharPositionInLine());
                    }
                    break;
                case 6:
                    enterOuterAlt(_localctx, 6);
                    {
                        ...
                        setNodePosition(
                                _localctx.expr,
                                ((ExpressionOtherContext) _localctx).trueModifier.getLine(),
                                ((ExpressionOtherContext) _localctx)
                                        .trueModifier.getCharPositionInLine());
                    }
                    break;
                case 7:
                    enterOuterAlt(_localctx, 7);
                    {
                        ...
                        setNodePosition(
                                _localctx.expr,
                                ((ExpressionOtherContext) _localctx).falseModifier.getLine(),
                                ((ExpressionOtherContext) _localctx)
                                        .falseModifier.getCharPositionInLine());
                    }
                    break;
                case 8:
                    enterOuterAlt(_localctx, 8);
                    {
                        ...
                        ((ExpressionOtherContext) _localctx).expr =
                                new Identifier(
                                        (((ExpressionOtherContext) _localctx).i1 != null
                                                ? ((ExpressionOtherContext) _localctx).i1.getText()
                                                : null));
                        setNodePosition(
                                _localctx.expr,
                                ((ExpressionOtherContext) _localctx).i1.getLine(),
                                ((ExpressionOtherContext) _localctx).i1.getCharPositionInLine());
                    }
                    break;
                case 9:
                    enterOuterAlt(_localctx, 9);
                    {
                        ...
                        Identifier instanceId =
                                new Identifier(
                                        (((ExpressionOtherContext) _localctx).i2 != null
                                                ? ((ExpressionOtherContext) _localctx).i2.getText()
                                                : null));
                        setNodePosition(
                                instanceId,
                                ((ExpressionOtherContext) _localctx).i2.getLine(),
                                ((ExpressionOtherContext) _localctx).i2.getCharPositionInLine());
                        ((ExpressionOtherContext) _localctx).expr =
                                new ArrayCall(
                                        instanceId, ((ExpressionOtherContext) _localctx).e.expr);
                        setNodePosition(
                                _localctx.expr,
                                ((ExpressionOtherContext) _localctx).leftBrace.getLine(),
                                ((ExpressionOtherContext) _localctx)
                                        .leftBrace.getCharPositionInLine());
                    }
                    break;
                case 10:
                    enterOuterAlt(_localctx, 10);
                    {
                        ...
                        ((ExpressionOtherContext) _localctx).expr =
                                ((ExpressionOtherContext) _localctx).ee.expr;
                    }
                    break;
                case 11:
                    enterOuterAlt(_localctx, 11);
                    {
                        ...
                        setNodePosition(
                                instance,
                                ((ExpressionOtherContext) _localctx).i3.getLine(),
                                ((ExpressionOtherContext) _localctx).i3.getCharPositionInLine());
                        Identifier methodName =
                                new Identifier(
                                        (((ExpressionOtherContext) _localctx).i3 != null
                                                ? ((ExpressionOtherContext) _localctx).i3.getText()
                                                : null));
                        setNodePosition(
                                methodName,
                                ((ExpressionOtherContext) _localctx).i3.getLine(),
                                ((ExpressionOtherContext) _localctx).i3.getCharPositionInLine());
                        ((ExpressionOtherContext) _localctx).expr =
                                new MethodCall(instance, methodName);
                        setNodePosition(
                                _localctx.expr,
                                ((ExpressionOtherContext) _localctx).i3.getLine(),
                                ((ExpressionOtherContext) _localctx).i3.getCharPositionInLine());
                        ...
                        if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 12517424486158336L) != 0)) {
                            {
                                ...
                                ((MethodCall) _localctx.expr)
                                        .addArg(((ExpressionOtherContext) _localctx).e3.expr);
                                setState(614);
                                _errHandler.sync(this);
                                _la = _input.LA(1);
                                while (_la == T__6) {
                ...
                if (_la == T__40) {
                    {
                        ...
                        setState(625);
                        match(T__41);
                        ((ToorlaTypeContext) _localctx).mType =
                                new ArrayType(((ToorlaTypeContext) _localctx).st.sType);
                    }
                }
            }
        } catch (RecognitionException re) {
                    ...
                    case ID:
                        {
                            ...
                            ((SingleTypeContext) _localctx).sType =
                                    new UserDefinedType(
                                            new ClassDeclaration(
                                                    new Identifier(
                                                            (((SingleTypeContext) _localctx).i
                                                                            != null
                                                                    ? ((SingleTypeContext)
                                                                                    _localctx)
                                                                            .i.getText()
    ...
    public static class ProgramContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ToorlaVisitor)
                return ((ToorlaVisitor<? extends T>) visitor).visitProgram(this);
    ...
    public static class ClassDeclarationContext extends ParserRuleContext {
        ...
        public ClassDeclarationContext(
                ParserRuleContext parent, int invokingState, boolean isEntry) {
            super(parent, invokingState);
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterClassDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitClassDeclaration(this);
        }
    ...
    public static class EntryClassDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterEntryClassDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitEntryClassDeclaration(this);
        }
    ...
    public static class FieldDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterFieldDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitFieldDeclaration(this);
        }
    ...
    public static class Access_modifierContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterAccess_modifier(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitAccess_modifier(this);
        }
    ...
    public static class MethodDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterMethodDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitMethodDeclaration(this);
        }
    ...
    public static class ClosedStatementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterClosedStatement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitClosedStatement(this);
        }
    ...
    public static class ClosedConditionalContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterClosedConditional(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitClosedConditional(this);
        }
    ...
    public static class OpenConditionalContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterOpenConditional(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitOpenConditional(this);
        }
    ...
    public static class OpenStatementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterOpenStatement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitOpenStatement(this);
        }
    ...
    public static class StatementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterStatement(this);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ToorlaVisitor)
                return ((ToorlaVisitor<? extends T>) visitor).visitStatement(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class StatementVarDefContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterStatementVarDef(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitStatementVarDef(this);
        }
    ...
    public static class StatementBlockContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterStatementBlock(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitStatementBlock(this);
        }
    ...
    public static class StatementContinueContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterStatementContinue(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitStatementContinue(this);
        }
    ...
    public static class StatementBreakContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterStatementBreak(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitStatementBreak(this);
        }
    ...
    public static class StatementReturnContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterStatementReturn(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitStatementReturn(this);
        }
    ...
    public static class StatementClosedLoopContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterStatementClosedLoop(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitStatementClosedLoop(this);
        }
    ...
    public static class StatementOpenLoopContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterStatementOpenLoop(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitStatementOpenLoop(this);
        }
    ...
    public static class StatementWriteContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterStatementWrite(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitStatementWrite(this);
        }
    ...
    public static class StatementAssignmentContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterStatementAssignment(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitStatementAssignment(this);
        }
    ...
    public static class StatementIncContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterStatementInc(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitStatementInc(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ToorlaVisitor)
                return ((ToorlaVisitor<? extends T>) visitor).visitStatementInc(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class StatementDecContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterStatementDec(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitStatementDec(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ToorlaVisitor)
                return ((ToorlaVisitor<? extends T>) visitor).visitStatementDec(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ExpressionContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterExpression(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitExpression(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ToorlaVisitor)
                return ((ToorlaVisitor<? extends T>) visitor).visitExpression(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ExpressionOrContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterExpressionOr(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitExpressionOr(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ToorlaVisitor)
                return ((ToorlaVisitor<? extends T>) visitor).visitExpressionOr(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ExpressionOrTempContext extends ParserRuleContext {
        ...
        public ExpressionOrTempContext(
                ParserRuleContext parent, int invokingState, Expression leftOperand) {
            super(parent, invokingState);
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterExpressionOrTemp(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitExpressionOrTemp(this);
        }
    ...
    public static class ExpressionAndContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterExpressionAnd(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitExpressionAnd(this);
        }
    ...
    public static class ExpressionAndTempContext extends ParserRuleContext {
        ...
        public ExpressionAndTempContext(
                ParserRuleContext parent, int invokingState, Expression leftOperand) {
            super(parent, invokingState);
            this.leftOperand = leftOperand;
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterExpressionAndTemp(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitExpressionAndTemp(this);
        }
    ...
    public static class ExpressionEqContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterExpressionEq(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitExpressionEq(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ToorlaVisitor)
                return ((ToorlaVisitor<? extends T>) visitor).visitExpressionEq(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ExpressionEqTempContext extends ParserRuleContext {
        ...
        public ExpressionEqTempContext(
                ParserRuleContext parent, int invokingState, Expression leftOperand) {
            super(parent, invokingState);
            this.leftOperand = leftOperand;
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterExpressionEqTemp(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitExpressionEqTemp(this);
        }
    ...
    public static class ExpressionCmpContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterExpressionCmp(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitExpressionCmp(this);
        }
    ...
    public static class ExpressionCmpTempContext extends ParserRuleContext {
        ...
        public ExpressionCmpTempContext(
                ParserRuleContext parent, int invokingState, Expression leftOperand) {
            super(parent, invokingState);
            this.leftOperand = leftOperand;
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterExpressionCmpTemp(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitExpressionCmpTemp(this);
        }
    ...
    public static class ExpressionAddContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterExpressionAdd(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitExpressionAdd(this);
        }
    ...
    public static class ExpressionAddTempContext extends ParserRuleContext {
        ...
        public ExpressionAddTempContext(
                ParserRuleContext parent, int invokingState, Expression leftOperand) {
            super(parent, invokingState);
            this.leftOperand = leftOperand;
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterExpressionAddTemp(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitExpressionAddTemp(this);
        }
    ...
    public static class ExpressionMultModContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterExpressionMultMod(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitExpressionMultMod(this);
        }
    ...
    public static class ExpressionMultModTempContext extends ParserRuleContext {
        ...
        public ExpressionMultModTempContext(
                ParserRuleContext parent, int invokingState, Expression leftOperand) {
            super(parent, invokingState);
            this.leftOperand = leftOperand;
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterExpressionMultModTemp(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitExpressionMultModTemp(this);
        }
    ...
    public static class ExpressionUnaryContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterExpressionUnary(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitExpressionUnary(this);
        }
    ...
    public static class ExpressionMethodsContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterExpressionMethods(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitExpressionMethods(this);
        }
    ...
    public static class ExpressionMethodsTempContext extends ParserRuleContext {
        ...
        public ExpressionMethodsTempContext(
                ParserRuleContext parent, int invokingState, Expression instance) {
            super(parent, invokingState);
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterExpressionMethodsTemp(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitExpressionMethodsTemp(this);
        }
    ...
    public static class ExpressionOtherContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterExpressionOther(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitExpressionOther(this);
        }
    ...
    public static class ToorlaTypeContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterToorlaType(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitToorlaType(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ToorlaVisitor)
                return ((ToorlaVisitor<? extends T>) visitor).visitToorlaType(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class SingleTypeContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).enterSingleType(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ToorlaListener)
                ((ToorlaListener) listener).exitSingleType(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ToorlaVisitor)
                return ((ToorlaVisitor<? extends T>) visitor).visitSingleType(this);
            else return visitor.visitChildren(this);
        }
    }
}
