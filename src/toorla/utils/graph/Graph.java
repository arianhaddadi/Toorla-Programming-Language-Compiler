...
public class Graph<Node> {
    private final Map<Node, Set<Node>> parentShipRelation;

    public Graph() {
        parentShipRelation = new HashMap<>();
    }

    public void addNodeAsParentOf(Node desired, Node parentNode)
            throws GraphDoesNotContainNodeException {
    ...
    public void addNode(Node desired) throws NodeAlreadyExistsException {
        if (parentShipRelation.containsKey(desired)) {
