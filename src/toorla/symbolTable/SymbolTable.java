...
public class SymbolTable {
    ...
    private static final Queue<SymbolTable> queue = new LinkedList<>();
    ...
    public SymbolTableItem getInParentScopes(String key) throws ItemNotFoundException {
        if (pre == null) throw new ItemNotFoundException();
            ...
            if (this.pre == this) throw new ItemNotFoundException();
            SymbolTable currentSymbolTable = this.pre;
            return getSymbolTableItemInCurrentOrParents(
                    key, visitedSymbolTables, currentSymbolTable);
        }
    }

    private SymbolTableItem getSymbolTableItemInCurrentOrParents(
            String key, Set<SymbolTable> visitedSymbolTables, SymbolTable currentSymbolTable)
